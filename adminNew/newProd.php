...
<body>
	...
	<?php
		...
		if(isset($_POST['submit']))
		{
			...
			{	
				...
				if(empty($errors)==true){
					move_uploaded_file($file_tmp,"D:/xmapp/htdocs/suhrad/$cat_fold/".$file_name);
					echo "Success";
				}else{
					print_r($errors);
				}
		...
		}$sql="INSERT INTO `$table`(`product_id`,`name`,`image`,`description`,`quant_avai`,`price`) 
			VALUES ('$id','$name','$img_name','$desc','$quant','$price')";
